                            ...
                            <form class="" role="form" action="{{url('settings/localization-post')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" data-live-search="true" name="date_format">
                                        ...
                                        <option value="d/m/Y H:i:s" @if(app_config('DateFormat') == 'd/m/Y H:i:s') selected="selected" @endif>15/05/2016 14:02:33</option>
                                        <option value="d.m.Y" @if(app_config('DateFormat') == 'd.m.Y') selected="selected" @endif>15.05.2016</option>
                                        <option value="d-m-Y" @if(app_config('DateFormat') == 'd-m-Y') selected="selected" @endif>15-05-2016</option>
                                ...
                                <div class="form-group">
                                    <label>{{language_data('Date Format')}}</label>
                                    <select class="form-control selectpicker" data-live-search="true" name="date_time_format">
                                        <option value="d/m/Y H:i:s" @if(app_config('DateTimeFormat') == 'd/m/Y H:i:s') selected="selected" @endif>15/05/2016 14:02:33</option>
										<option value="d/m/Y" @if(app_config('DateTimeFormat') == 'd/m/Y') selected="selected" @endif>15/05/2016</option>
                                        <option value="d.m.Y" @if(app_config('DateTimeFormat') == 'd.m.Y') selected="selected" @endif>15.05.2016</option>
                                        <option value="d-m-Y" @if(app_config('DateTimeFormat') == 'd-m-Y') selected="selected" @endif>15-05-2016</option>
                                        <option value="m/d/Y" @if(app_config('DateTimeFormat') == 'm/d/Y') selected="selected" @endif>05/15/2016</option>
                                        <option value="Y/m/d" @if(app_config('DateTimeFormat') == 'Y/m/d') selected="selected" @endif>2016/05/15</option>
                                        <option value="Y-m-d" @if(app_config('DateTimeFormat') == 'Y-m-d') selected="selected" @endif>2016-05-15</option>
                                        <option value="M d Y" @if(app_config('DateTimeFormat') == 'M d Y') selected="selected" @endif>May 15 2016</option>
                                        <option value="d M Y" @if(app_config('DateTimeFormat') == 'd M Y') selected="selected" @endif>15 May 2016</option>
                                        <option value="jS M y" @if(app_config('DateTimeFormat') == 'jS M y') selected="selected" @endif>15th May 16</option>
                                    </select>
                                </div>

                 ...
                 <div class="col-lg-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="get" action="{{url('sms/historyFile')}}" enctype="multipart/form-data">
                                ...
                                <a href="{{url('sms/historyFile')}}"><button type="button" class="btn btn-danger"><i class="fa fa-plus"></i> Reset </button></a>
                            </div>
                            </form>
                        </div>
                    </div>
        ...
        <script>
            jQuery(document).ready(function($) {
                var engine = new Bloodhound({
                    remote: {
                        url: _url+'/admin/findMobile?q=%QUERY%',
                        wildcard: '%QUERY%'
                    },

                 ...
                 <div class="col-lg-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="get" action="{{url('sms/historyFileSchedule')}}" enctype="multipart/form-data">
                                ...
                                <a href="{{url('sms/historyFileSchedule')}}"><button type="button" class="btn btn-danger"><i class="fa fa-plus"></i> Reset </button></a>
                            </div>
                            </form>
                        </div>
                    </div>
                                ...
                                @foreach($sms_history as $h)
                                    <tr>
                                        ...
                                        <td data-label="Actions">
                                            <a class="btn btn-success btn-xs" href="{{url('sms/manage-update-schedule-sms-file/'.$h->id)}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}</a>
        ...
        <script>
            jQuery(document).ready(function($) {
                var engine = new Bloodhound({
                    remote: {
                        url: _url+'/admin/findMobileSchedule?q=%QUERY%',
                        wildcard: '%QUERY%'
                    },
        ...
        $(document).ready(function(){
            ...
            $( "body" ).delegate( ".cdelete", "click",function (e) {
                ...
                bootbox.confirm("Are you sure?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/sms/delete-schedule-sms-file/" + id;
                    }
                });
            });
        });
